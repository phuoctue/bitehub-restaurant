...
-- CreateEnum
CREATE TYPE "DishStatus" AS ENUM ('Available', 'Unavailable', 'Hidden');

-- CreateEnum
CREATE TYPE "TableStatus" AS ENUM ('Available', 'Hidden', 'Reserved');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('Pending', 'Processing', 'Rejected', 'Delivered', 'Paid', 'Cancelled');
